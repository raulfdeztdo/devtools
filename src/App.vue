...
// Global SEO: reactive lang, canonical and default meta tags
// Individual views override title/description via their own useSeoMeta call
useSeoMeta();
...
const tools = [
  ...
  {
    path: "/jsonlint",
    name: "tools.jsonlint.name",
    icon: FileSearch,
    category: "json",
  },
  {
    path: "/json-schema-validator",
    name: "tools.schemaValidator.name",
    icon: ShieldCheck,
    category: "json",
  },
  {
    path: "/json-compare",
    name: "tools.jsonCompare.name",
    icon: GitCompare,
    category: "json",
  },
  {
    path: "/yaml-json",
    name: "tools.yamlJson.name",
    icon: FileJson,
    category: "json",
  },
  {
    path: "/toml-json",
    name: "tools.tomlJson.name",
    icon: FileType2,
    category: "json",
  },
  {
    path: "/xml-json",
    name: "tools.xmlJson.name",
    icon: FileCode2,
    category: "json",
  },
  // Encoding
  ...
  {
    path: "/hash-generator",
    name: "tools.hashGenerator.name",
    icon: Hash,
    category: "encoding",
  },
  {
    path: "/jwt-decoder",
    name: "tools.jwtDecoder.name",
    icon: KeySquare,
    category: "encoding",
  },
  {
    path: "/html-entity-encoder",
    name: "tools.htmlEntityEncoder.name",
    icon: Code2,
    category: "encoding",
  },
  {
    path: "/php-serializer",
    name: "tools.phpSerializer.name",
    icon: Braces,
    category: "encoding",
  },
  // Formatting
  {
    path: "/regex-tester",
    name: "tools.regexTester.name",
    icon: Regex,
    category: "formatting",
  },
  {
    path: "/sql-formatter",
    name: "tools.sqlFormatter.name",
    icon: Database,
    category: "formatting",
  },
  {
    path: "/css-js-minifier",
    name: "tools.cssJsMinifier.name",
    icon: Minimize2,
    category: "formatting",
  },
  {
    path: "/markdown-preview",
    name: "tools.markdownPreview.name",
    icon: BookOpen,
    category: "formatting",
  },
  // Generators
  ...
  {
    path: "/lorem-ipsum",
    name: "tools.loremIpsum.name",
    icon: AlignLeft,
    category: "generators",
  },
  {
    path: "/cron-parser",
    name: "tools.cronParser.name",
    icon: Timer,
    category: "generators",
  },
  {
    path: "/qr-generator",
    name: "tools.qrGenerator.name",
    icon: QrCode,
    category: "generators",
  },
  {
  ...
  },
  {
    ...
    name: "tools.httpStatusCodes.name",
    icon: Info,
    category: "web",
  },
  {
    path: "/user-agent-parser",
    name: "tools.userAgentParser.name",
    icon: UserSearch,
    category: "web",
  },
  {
    path: "/favicon-generator",
    name: "tools.faviconGenerator.name",
    icon: Image,
    category: "web",
  },
  {
    path: "/color-palette-generator",
    name: "tools.colorPalette.name",
    icon: Palette,
    category: "web",
  },
  // Text
  {
    path: "/text-diff",
    name: "tools.textDiff.name",
    icon: Repeat2,
    category: "text",
  },
  {
    path: "/case-converter",
    name: "tools.caseConverter.name",
    icon: Type,
    category: "text",
  },
  {
    path: "/string-counter",
    name: "tools.stringCounter.name",
    icon: ScanText,
    category: "text",
  },
];
...
onMounted(() => {
  ...
  ldScript.textContent = JSON.stringify({
    ...
    "@type": "WebApplication",
    name: "DevToolset",
    url: "https://devtoolset.netlify.app",
    description:
      "Free developer tools suite: JSON validator, UUID generator, Base64 converter, regex tester, SQL formatter, JWT decoder, and 23 more utilities. No registration required, all processing happens in your browser.",
    ...
    author: {
      "@type": "Person",
      name: "raulfdeztdo",
      url: "https://raulfdez.dev/",
    },
    inLanguage: ["es", "en"],
    isAccessibleForFree: true,
    sameAs: ["https://github.com/raulfdeztdo/devtools"],
  });
...
<template>
  <div
    class="flex flex-col min-h-screen transition-colors duration-300 bg-gray-50 dark:bg-night-bg"
  >
    <!-- Header -->
    <header
      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                  ...
                  >
                    <div class="p-2 grid grid-cols-2 gap-x-2">
                      ...
                      >
                        <div class="mb-2">
                          <div
                            class="px-2 pt-1 pb-1 text-xs font-semibold tracking-wider uppercase text-gray-400 dark:text-gray-500"
                          >
                            {{ t(cat.nameKey) }}
                          </div>
                          <router-link
                            ...
                            :class="{
                              'bg-brand-blue/5 text-brand-blue dark:bg-brand-blue/10 dark:text-brand-blue-lighter':
                                $route.path === tool.path,
                            }"
                          >
                            <span
                              class="flex items-center justify-center w-6 h-6 rounded-md bg-gray-100 dark:bg-gray-800 flex-shrink-0"
                              :class="{
        ...
        >
          <div
            ...
            class="pb-4 border-t border-gray-200/60 dark:border-night-border/60 md:hidden max-h-[70vh] overflow-y-auto"
          >
            <div class="pt-3 space-y-1">
              <router-link
                ...
                :class="{
                  'text-brand-blue dark:text-brand-blue-lighter bg-brand-blue/5 dark:bg-brand-blue/10':
                    $route.path === '/',
                }"
              >
                {{ t("nav.home") }}
              ...
              >
                ...
                >
                  <span
                    class="flex items-center justify-center w-7 h-7 rounded-md bg-gray-100 dark:bg-gray-800"
                  >
    ...
    <!-- Footer -->
    <footer
      class="py-6 mt-auto border-t border-gray-200/60 dark:border-gray-800/60"
    >
      <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
        <p class="text-sm text-gray-500 dark:text-gray-400">
          {{ t("footer.madeBy") }}
          <a
            href="https://raulfdez.dev/"
            target="_blank"
          ...
          <a
            href="https://github.com/raulfdeztdo/devtools"
            target="_blank"
            rel="noopener noreferrer"
