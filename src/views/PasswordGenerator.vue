    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="mb-8 text-center">
        <h1 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">
          <KeyRound class="inline-block w-5 h-5" />
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-3">
                ...
                <label class="flex items-center gap-2">
                  ...
                  />
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{
                    t("tools.password.excludeSimilar")
                  }}</span>
                </label>
              </div>
              ...
              >
                ...
                {{ t("tools.password.generatePassword") }}
              </button>

              <!-- Batch Generation -->
              <div
                class="pt-4 border-t border-gray-200 dark:border-night-border"
              >
                <label
                  class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                ...
                <div class="flex gap-2">
                  <input
                    ...
                    :placeholder="t('tools.password.quantity')"
                  />
                  <button
                    @click="generateBatch"
                    :disabled="!hasValidOptions"
        ...
        <div class="lg:col-span-2">
          ...
          <div v-if="generatedPassword" class="p-6 mb-6 card">
            <div class="flex items-center justify-between mb-4">
              ...
              <div class="flex gap-2">
                <button
                  ...
                  class="p-2 text-sm btn-secondary"
                  :title="t('common.copy')"
                >
            ...
            <div class="mt-4">
              ...
              <div
                class="w-full h-2 bg-gray-200 rounded-full dark:bg-night-card-inner"
              >
                <div
          ...
          <div v-if="batchPasswords.length > 0" class="p-6 card">
            ...
            <div class="space-y-2 overflow-y-auto max-h-64">
              ...
              >
                <span
                  class="flex-1 font-mono text-sm text-gray-900 break-all dark:text-white"
                  >{{ password }}</span
                >
                <button
          ...
          <!-- Empty State -->
          <div
            v-if="!generatedPassword && batchPasswords.length === 0"
            class="p-12 text-center card"
          >
            <div class="mb-4">
      ...
      <div class="p-6 mt-8 card">
        <h3 class="mb-4 text-base font-semibold text-gray-900 dark:text-white">
          <Lightbulb class="inline-block w-5 h-5" />
          {{ t("tools.password.securityTips") }}
        </h3>
        <div
        ...
        >
          <div>
            <span class="font-medium text-gray-900 dark:text-white">{{
              t("tools.password.lengthLabel")
            }}</span>
            {{ t("tools.password.tipLength") }}
          </div>
          <div>
            <span class="font-medium text-gray-900 dark:text-white">{{
              t("tools.password.varietyLabel")
            }}</span>
            {{ t("tools.password.tipVariety") }}
          </div>
          <div>
            <span class="font-medium text-gray-900 dark:text-white">{{
              t("tools.password.uniqueLabel")
            }}</span>
            {{ t("tools.password.tipUnique") }}
          </div>
          <div>
            <span class="font-medium text-gray-900 dark:text-white">{{
              t("tools.password.managerLabel")
            }}</span>
