...
const tools = [
  {
    path: "/jsonlint",
    nameKey: "tools.jsonlint.name",
    descKey: "tools.jsonlint.description",
    icon: FileSearch,
    category: "json",
  },
  {
    path: "/json-schema-validator",
    nameKey: "tools.schemaValidator.name",
    descKey: "tools.schemaValidator.description",
    icon: ShieldCheck,
    category: "json",
  },
  {
    path: "/json-compare",
    nameKey: "tools.jsonCompare.name",
    descKey: "tools.jsonCompare.description",
    icon: GitCompare,
    category: "json",
  },
  {
    path: "/yaml-json",
    nameKey: "tools.yamlJson.name",
    descKey: "tools.yamlJson.description",
    icon: FileJson,
    category: "json",
  },
  {
    path: "/toml-json",
    nameKey: "tools.tomlJson.name",
    descKey: "tools.tomlJson.description",
    icon: FileType2,
    category: "json",
  },
  {
    path: "/xml-json",
    nameKey: "tools.xmlJson.name",
    descKey: "tools.xmlJson.description",
    icon: FileCode2,
    category: "json",
  },
  {
  ...
  },
  {
    ...
    nameKey: "tools.htmlEntityEncoder.name",
    descKey: "tools.htmlEntityEncoder.description",
    icon: Code2,
    category: "encoding",
  },
  {
    path: "/php-serializer",
    nameKey: "tools.phpSerializer.name",
    descKey: "tools.phpSerializer.description",
    icon: Braces,
    category: "encoding",
  },
  {
  ...
  },
  {
    ...
    descKey: "tools.sqlFormatter.description",
    icon: Database,
    category: "formatting",
  },
  {
    path: "/css-js-minifier",
    nameKey: "tools.cssJsMinifier.name",
    descKey: "tools.cssJsMinifier.description",
    icon: Minimize2,
    category: "formatting",
  },
  {
    ...
    descKey: "tools.markdownPreview.description",
    icon: BookOpen,
    category: "formatting",
  },
  {
    ...
    descKey: "tools.uuid.description",
    icon: Fingerprint,
    category: "generators",
  },
  {
    ...
    descKey: "tools.password.description",
    icon: KeyRound,
    category: "generators",
  },
  {
    ...
    descKey: "tools.loremIpsum.description",
    icon: AlignLeft,
    category: "generators",
  },
  {
    path: "/cron-parser",
    nameKey: "tools.cronParser.name",
  ...
  },
  {
    ...
    descKey: "tools.timestamp.description",
    icon: Clock,
    category: "generators",
  },
  {
  ...
  },
  {
    ...
    descKey: "tools.httpStatusCodes.description",
    icon: Info,
    category: "web",
  },
  {
    ...
    descKey: "tools.userAgentParser.description",
    icon: UserSearch,
    category: "web",
  },
  {
    ...
    descKey: "tools.faviconGenerator.description",
    icon: Image,
    category: "web",
  },
  {
    ...
    descKey: "tools.colorPalette.description",
    icon: Palette,
    category: "web",
  },
  {
    ...
    descKey: "tools.textDiff.description",
    icon: Repeat2,
    category: "text",
  },
  {
    ...
    descKey: "tools.caseConverter.description",
    icon: Type,
    category: "text",
  },
  {
    path: "/string-counter",
    nameKey: "tools.stringCounter.name",
    descKey: "tools.stringCounter.description",
    icon: ScanText,
    category: "text",
  },
];
  ...
  <div class="py-10">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="mb-8 text-center">
        ...
        >
          {{ t("home.title") }}
          <span class="text-brand-blue dark:text-brand-blue-lighter">{{
            t("home.titleHighlight")
          }}</span>
        </h1>
        <p
          class="max-w-2xl mx-auto mt-3 text-base text-gray-500 dark:text-gray-400"
        >
      ...
      <template v-if="activeCategory === 'all'">
        ...
        >
          <h3
            class="mb-3 text-sm font-semibold tracking-wider uppercase text-gray-400 dark:text-gray-500"
          >
            {{ t(cat.nameKey) }}
          </h3>
          <div
          ...
          >
            ...
            >
              <div
                class="flex items-center justify-center w-9 h-9 rounded-lg bg-brand-blue/5 dark:bg-brand-blue/10"
              >
                <component
                  :is="tool.icon"
                  class="w-4.5 h-4.5 text-brand-blue dark:text-brand-blue-lighter"
                />
              </div>
              <div>
                <p
                  class="text-xs font-semibold text-gray-900 dark:text-white leading-tight"
                >
                  {{ t(tool.nameKey) }}
                </p>
                <p
                  class="mt-0.5 text-xs text-gray-500 dark:text-gray-400 leading-tight line-clamp-2"
                >
                  {{ t(tool.descKey) }}
                </p>
              </div>
