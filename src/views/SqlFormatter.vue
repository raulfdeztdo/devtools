...
const { t } = useI18n();
useSeoMeta({
  titleKey: "tools.sqlFormatter.title",
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="mb-8 text-center">
        <h1 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white">
          <Database class="inline-block w-6 h-6 mr-2" />{{
      ...
      <div class="flex flex-wrap items-center gap-3 mb-6">
        ...
        <div class="flex items-center gap-2">
          ...
          <select
            ...
            class="input-field !w-auto text-sm py-1.5"
          >
        ...
        <div class="flex gap-2">
          ...
          >
            ...
            {{ t("tools.sqlFormatter.minifyBtn") }}
          </button>
          <button
            @click="loadSample"
            class="btn-secondary flex items-center gap-1.5"
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        ...
        <div class="p-6 card">
          ...
          <div
            v-if="outputStats"
            class="mt-2 text-xs text-gray-500 dark:text-gray-400 flex gap-4"
          >
            <span
              >{{ outputStats.lines }} {{ t("tools.sqlFormatter.lines") }}</span
            >
