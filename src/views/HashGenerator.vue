    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="mb-8 text-center">
        <h1 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">
          <Hash class="inline-block w-5 h-5" />
        ...
        <div class="space-y-4">
          ...
          >
            <div class="flex items-center justify-between mb-2">
              <span
                class="text-sm font-semibold text-brand-blue dark:text-brand-blue-lighter"
              >
                {{ row.algo }}
              </span>
              <button
      ...
      <!-- Security notice -->
      <div
        class="flex items-start gap-3 p-4 mt-6 border border-green-200 rounded-lg bg-green-50 dark:bg-green-900/20 dark:border-green-800"
      >
        <ShieldCheck
          class="w-5 h-5 mt-0.5 text-green-600 dark:text-green-400 shrink-0"
        />
