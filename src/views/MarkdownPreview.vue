  ...
  <div class="py-8">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
        <!-- View mode toggle -->
        <div
          class="flex rounded-lg border border-gray-300 dark:border-night-border overflow-hidden"
        >
          <button
          ...
          >
            ...
            {{
              t(
                `tools.markdownPreview.mode${mode.charAt(0).toUpperCase() + mode.slice(1)}`,
              )
            }}
          </button>
        </div>
        ...
        >
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.markdownPreview.infoSyntaxLabel") }}
            </div>
            <p class="text-xs">{{ t("tools.markdownPreview.infoSyntax") }}</p>
          </div>
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.markdownPreview.infoListsLabel") }}
            </div>
            <p class="text-xs">{{ t("tools.markdownPreview.infoLists") }}</p>
          </div>
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.markdownPreview.infoGfmLabel") }}
            </div>
            <p class="text-xs">{{ t("tools.markdownPreview.infoGfm") }}</p>
          </div>
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.markdownPreview.infoExportLabel") }}
            </div>
