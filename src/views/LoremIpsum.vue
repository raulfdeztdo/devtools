...
useSeoMeta({
  titleKey: "tools.loremIpsum.title",
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="mb-8 text-center">
        <h1 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white">
          <Type class="inline-block w-6 h-6 mr-2" />{{
            t("tools.loremIpsum.title")
          }}
        </h1>
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="p-6 card">
          ...
          <div class="space-y-5">
              ...
              <div class="space-y-2">
                <label class="flex items-center gap-2 cursor-pointer">
                  ...
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{
                    t("tools.loremIpsum.typeParagraphs")
                  }}</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                  <input
                  ...
                  />
                  <span class="text-sm text-gray-700 dark:text-gray-300">{{
                    t("tools.loremIpsum.typeSentences")
                  }}</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                  <input
            ...
            <label class="flex items-start gap-2 cursor-pointer">
              ...
              />
              <span class="text-sm text-gray-700 dark:text-gray-300">{{
                t("tools.loremIpsum.startWithLorem")
              }}</span>
            </label>
        ...
        <div class="p-6 card lg:col-span-2">
          ...
          <div
            v-if="output"
            class="mt-2 flex gap-4 text-xs text-gray-500 dark:text-gray-400"
          >
      ...
      <div class="p-6 mt-8 card">
        ...
        <div
          class="grid gap-4 text-sm text-gray-600 dark:text-gray-400 md:grid-cols-3"
        >
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.loremIpsum.infoOriginLabel") }}
            </div>
            <p class="text-xs">{{ t("tools.loremIpsum.infoOrigin") }}</p>
          </div>
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.loremIpsum.infoUseLabel") }}
            </div>
            <p class="text-xs">{{ t("tools.loremIpsum.infoUse") }}</p>
          </div>
          <div class="p-3 rounded-lg bg-gray-50 dark:bg-night-card-inner">
            <div class="font-medium text-gray-900 dark:text-white mb-1">
              {{ t("tools.loremIpsum.infoVariationsLabel") }}
            </div>
