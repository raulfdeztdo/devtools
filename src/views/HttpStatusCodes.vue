...
useSeoMeta({
  titleKey: "tools.httpStatusCodes.title",
...
const categories = [
  ...
  {
    id: "1xx",
    label: computed(() => t("tools.httpStatusCodes.informational")),
  },
...
const filteredCodes = computed(() => {
  ...
  return statusCodes.filter((item) => {
    ...
    const matchesSearch =
      ...
      t(`tools.httpStatusCodes.codes.${item.code}.description`)
        .toLowerCase()
        .includes(query);
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">
          {{ t("tools.httpStatusCodes.subtitle") }}
        </p>
      </div>
        ...
        <div v-else class="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          >
            ...
            <div class="flex items-center gap-4 px-4 py-3">
              ...
              />
              <ChevronUp v-else class="w-4 h-4 text-gray-400 flex-shrink-0" />
            </div>
            ...
            >
              <div
                class="pl-18 ml-14 border-l-2 border-gray-200 dark:border-gray-700 pl-4"
              >
                <p
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  {{ t(`tools.httpStatusCodes.codes.${item.code}.useCases`) }}
                </p>
              </div>
            </div>
          </div>
