    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">
          {{ t("tools.faviconGenerator.subtitle") }}
        </p>
      </div>
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        ...
        <div class="space-y-6">
          ...
          <div class="p-6 card">
            ...
            >
              {{ t("tools.faviconGenerator.source") }}
            </h2>
          ...
          <div v-if="mode === 'text'" class="p-6 card space-y-4">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white">
              {{ t("tools.faviconGenerator.textOptions") }}
            </h2>
            ...
            <div>
              ...
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {{ t("tools.faviconGenerator.textHint") }}
              </p>
            </div>
            ...
            <div>
              ...
              <select v-model="font" class="input-field w-full">
                <option value="system">
                  {{ t("tools.faviconGenerator.fontSystem") }}
                </option>
                <option value="serif">
                  {{ t("tools.faviconGenerator.fontSerif") }}
                </option>
                <option value="mono">
                  {{ t("tools.faviconGenerator.fontMono") }}
                </option>
              </select>
            </div>
          </div>
          ...
          <div v-if="mode === 'image'" class="p-6 card space-y-4">
            <h2 class="text-base font-semibold text-gray-900 dark:text-white">
              {{ t("tools.faviconGenerator.imageOptions") }}
            </h2>
            <div
            ...
            >
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ t("tools.faviconGenerator.uploadHint") }}
              </p>
        ...
        <div class="space-y-6">
          ...
          <div class="p-6 card">
            <h2
              class="mb-4 text-base font-semibold text-gray-900 dark:text-white"
            >
              {{ t("tools.faviconGenerator.preview") }}
            </h2>
            <div class="flex items-center gap-6">
              ...
              <div class="text-sm text-gray-500 dark:text-gray-400">
                <p>128 × 128 px</p>
                <p class="mt-1">
                  {{ t("tools.faviconGenerator.previewNote") }}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="p-6 card">
            <h2
              class="mb-4 text-base font-semibold text-gray-900 dark:text-white"
            >
              {{ t("tools.faviconGenerator.downloadSizes") }}
            </h2>
            <div class="space-y-3">
              <div
                v-for="size in sizes"
