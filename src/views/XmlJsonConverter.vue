...
const { t } = useI18n();
useSeoMeta({
  titleKey: "tools.xmlJson.title",
  descriptionKey: "tools.xmlJson.description",
});
...
const inputLabel = computed(() =>
  direction.value === "xml-to-json"
    ? t("tools.xmlJson.xmlLabel")
    : t("tools.xmlJson.jsonLabel"),
);
...
const inputPlaceholder = computed(() =>
  direction.value === "xml-to-json"
    ? t("tools.xmlJson.xmlPlaceholder")
    : t("tools.xmlJson.jsonPlaceholder"),
);
const outputPlaceholder = computed(() =>
  direction.value === "xml-to-json"
    ? t("tools.xmlJson.jsonOutputPlaceholder")
    : t("tools.xmlJson.xmlOutputPlaceholder"),
);
...
function swapDirection() {
  ...
  error.value = "";
  direction.value =
    direction.value === "xml-to-json" ? "json-to-xml" : "xml-to-json";
