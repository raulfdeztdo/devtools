...
description: >
  Vue 3 internationalization implementation for this devtools project using vue-i18n.
  Provides systematic AI-driven workflow to achieve 100% i18n coverage with
  zero hardcoded strings in SOURCE CODE. Use for adding i18n, migrating hardcoded
  strings, adding new language support, or auditing i18n coverage.
  CRITICAL: This skill focuses ONLY on source code internationalization
  (components, views, UI), NOT documentation files (README.md, docs/).
  Adapted for Vue 3 Composition API with `<script setup>` and vue-i18n.
---
